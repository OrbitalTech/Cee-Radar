                ...
                Box(modifier = Modifier
                    ...
                    Column(
                        ...
                        Box(
                            ...
                            Icon(painter = painterResource(id = R.drawable.ic_sound_on), modifier = Modifier.size(45.dp), tint =if (currentStatus.value == 1) Color.White else Color(0XFF989898) , contentDescription ="" )
                        }
                ...
                Box(modifier = Modifier
                    ...
                    Column(
                        ...
                        Box(
                            ...
                            Icon(painter = painterResource(id = R.drawable.ic_sound_off), modifier = Modifier.size(45.dp), tint = if (currentStatus.value == 3) Color.White else Color(0XFF989898), contentDescription ="" )
                        }
                        Spacer(modifier = Modifier.height(20.dp))
