...
import com.orbital.cee.view.home.appMenu.componenets.CursorCarousel
import com.orbital.cee.view.home.appMenu.componenets.PromotionCarousel
import com.orbital.cee.view.home.appMenu.componenets.SpeedometerCarousel

@Composable
fun themes(speedometerID :String ,
           cursorId :String ,
           onClickBack:()->Unit,
           onClickUnlockSpeedometer:()->Unit,
           ownSpeedometers : List<String?>?,
           ownCursor : List<String?>?,
    ...
    Column(modifier = Modifier
        ...
        SpeedometerCarousel(speedometerID,onClickUnlockSpeedometer,ownSpeedometers,onClickUnlockHitexSpeedometer,onSelectedSpeedometer)
        Spacer(modifier = Modifier.height(20.dp))
        Text(text = "Cursor", color = black, fontSize = 20.sp, fontWeight = FontWeight.Medium)
        Spacer(modifier = Modifier.height(12.dp))
        CursorCarousel(cursorId,ownCursor,onClickUnlockHitexSpeedometer,onSelectedCursor)
